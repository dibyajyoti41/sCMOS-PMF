function [pdfsCMOS,cdfsCMOS] = pdf_cdf_scmos(intensities,lambda,gain,shapep,adFactor,offset,roNoise,L,U)

    % Generates sCMOS probability density function (PDF) and 
    ...
    % Output:
    % 
    % pdfsCMOS = sCMOS probability density function 
    % cdfsCMOS = cumulative distribution function 
    %
